...
csv_file_path_nhl = f"odds-lines-data/betonline/nhl/nhl_betonline_odds_{current_date}.csv"
csv_file_path_nba = f"odds-lines-data/betonline/nba/nba_betonline_odds_{current_date}.csv"
